...
const octokit = new Octokit({ auth: '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' });// ඔයා 𝚐𝚒𝚝𝚑𝚞𝚋 𝚝𝚘𝚔𝚎𝚗 එකක් අරන් ඒක දාන්න
const owner = 'Raviya-cmd';//𝚐𝚒𝚝𝚑𝚞𝚋 𝙰𝙲𝙲𝙾𝚄𝙽𝚃 එකේ 𝚞𝚜𝚎𝚗𝚊𝚖𝚎 දාන්න 
const repo = 'Raviya-wa-bot';//𝚐𝚒𝚝𝚑𝚞𝚋 𝚛𝚎𝚙𝚘 එකක් හදලා ඒකේ නම දාන්න
